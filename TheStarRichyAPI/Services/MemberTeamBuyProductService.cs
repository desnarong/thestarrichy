...
{
    public interface IMemberTeamBuyProductService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class MemberTeamBuyProductService : IMemberTeamBuyProductService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberTeamBuyProductService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetMember2DisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT ROW_NUMBER() OVER(ORDER BY quantity desc) as Num,* FROM [000_Member_Team_buy_product] WHERE Membercode = @Membercode order by quantity  desc  ";
