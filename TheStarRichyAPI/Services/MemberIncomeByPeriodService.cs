...
{
    public interface IMemberIncomeByPeriodService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class MemberIncomeByPeriodService : IMemberIncomeByPeriodService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberIncomeByPeriodService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetMember2DisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT ROW_NUMBER() OVER (ORDER BY Numofperiod ) AS Num,* FROM [000_IncomeByPeriod] WHERE Membercode = @Membercode ORDER BY Numofperiod";
