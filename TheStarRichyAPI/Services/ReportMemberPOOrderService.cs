...
{
    public interface IReportMemberPOOrderService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberPOOrderService : IReportMemberPOOrderService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberPOOrderService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
