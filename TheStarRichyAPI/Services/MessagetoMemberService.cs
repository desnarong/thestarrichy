...
{
    public interface IMessagetoMemberService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class MessagetoMemberService : IMessagetoMemberService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MessagetoMemberService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
