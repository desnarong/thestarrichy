...
{
    public interface IMemberTeamNewRegisterService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class MemberTeamNewRegisterService : IMemberTeamNewRegisterService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberTeamNewRegisterService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetMember2DisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT ROW_NUMBER() OVER (ORDER BY Regisdatetime DESC) AS Num,* FROM [000_TeamNewRegister] WHERE Membercode = @Membercode ORDER BY Regisdatetime DESC  ";
