...
namespace TheStarRichyApi.Services
{
    ...
    public class BranchService : IBranchService
    {
        ...
        public BranchService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT M39_PX1,M39_X2       ";
                    query += " FROM M39   (nolock)  ";
                    query += " where M39_X10<>'1'       ";

                    query += " order by M39_PX1 ";
