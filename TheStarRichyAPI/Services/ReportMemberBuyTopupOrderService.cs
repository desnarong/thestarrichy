...
{
    public interface IReportMemberBuyTopupOrderService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberBuyTopupOrderService : IReportMemberBuyTopupOrderService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberBuyTopupOrderService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    query += " ORDER BY Create_date desc,BillNo desc,ProductID ";
