...
{
    public interface IReportMemberBonusByMonthService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberBonusByMonthService : IReportMemberBonusByMonthService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberBonusByMonthService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT * FROM [000_Member_bonus_for_mobile_monthly]  (nolock) ";
