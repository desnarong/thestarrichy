...
namespace TheStarRichyApi.Services
{
    ...
    public class ProductGroupService : IProductGroupService
    {
        ...
        public ProductGroupService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT  ProductGroupCode, ProductGroupThaiName ,  ProductGroupEngName";
                    query += " FROM [000_GroupOfProduct]   ";
     
                    query += " order by GroupOrder,ProductGroupCode ";
