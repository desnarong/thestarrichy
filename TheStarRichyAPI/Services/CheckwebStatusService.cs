...
{
    public interface ICheckwebStatusService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class CheckwebStatusService : ICheckwebStatusService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public CheckwebStatusService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT * FROM [000_Checkwebstatus] ";
