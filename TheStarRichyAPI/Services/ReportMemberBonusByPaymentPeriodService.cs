...
{
    public interface IReportMemberBonusByPaymentPeriodService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberBonusByPaymentPeriodService : IReportMemberBonusByPaymentPeriodService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberBonusByPaymentPeriodService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    query += ", MatchingBonus ,StrongBonus, AllSaleBonus, MobileBonus,  UnilevelBonus, SpecialBonus,  TotalBonus  ";
                    query += ",ServicePrice ,TotalBonusAfterExpense ,Tax ,TotalBonusIncudeTax ,WithHoldingTax ,NetBonus, PeriodName ";
