...
{
    public interface IEstimatePositionService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class EstimatePositionService : IEstimatePositionService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public EstimatePositionService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT top 5 [M06_PX1],[EstimatePosistion],EstimatetWeakleg,[LeftEstimate],[RightEstimate] FROM [000_EstimatePosition] where M06_PX1=@Membercode ORDER BY M06_PX1,EstimateLevelcode ";
