...
{
    public interface IMemberTeamTotalPositionRankingService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class MemberTeamTotalPositionRankingService : IMemberTeamTotalPositionRankingService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberTeamTotalPositionRankingService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetMember2DisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT * FROM [000_Member_Team_total_position_ranking] WHERE Membercode = @Membercode ORDER BY Levelcode";
