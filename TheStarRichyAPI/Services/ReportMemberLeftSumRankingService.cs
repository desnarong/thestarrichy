...
{
    public interface IReportMemberLeftSumRankingService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberLeftSumRankingService : IReportMemberLeftSumRankingService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberLeftSumRankingService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT * FROM [000_Member_Left_Sum_position_Ranking] where Membercode=@Membercode ORDER BY LevelCode ";
