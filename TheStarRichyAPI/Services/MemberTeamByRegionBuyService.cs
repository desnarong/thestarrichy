...
{
    public interface IMemberTeamByRegionBuyService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class MemberTeamByRegionBuyService : IMemberTeamByRegionBuyService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberTeamByRegionBuyService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetMember2DisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT * FROM [000_Member_team_by_Region_BUY] WHERE Membercode = @Membercode order by Region_ID";
