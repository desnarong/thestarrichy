...
{
    public interface IMemberTeamNewBuyService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class MemberTeamNewBuyService : IMemberTeamNewBuyService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberTeamNewBuyService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetMember2DisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT ROW_NUMBER() OVER (ORDER BY OrderDateTime DESC) AS Num,* FROM [000_TeamNewBuy] WHERE Membercode = @Membercode ORDER BY OrderDateTime DESC  ";
