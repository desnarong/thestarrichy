...
{
    public interface IGroupofProductsService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class GroupofProductsService : IGroupofProductsService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public GroupofProductsService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
