...
{
    public interface IReportMemberRightSumRankingService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberRightSumRankingService : IReportMemberRightSumRankingService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberRightSumRankingService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT * FROM [000_Member_Right_Sum_position_Ranking] where Membercode=@Membercode ORDER BY LevelCode ";
