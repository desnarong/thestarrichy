...
{
    public interface IReportMemberPositionHistoryService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberPositionHistoryService : IReportMemberPositionHistoryService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberPositionHistoryService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT  Membercode,Baldate,Baldate1,Balance,LeftCount,RightCount,Position";
                    query += " ,Ranking,LeftPS,RightPS  ";
