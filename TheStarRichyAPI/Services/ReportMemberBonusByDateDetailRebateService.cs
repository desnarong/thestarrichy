...
{
    public interface IReportMemberBonusByDateDetailRebateService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberBonusByDateDetailRebateService : IReportMemberBonusByDateDetailRebateService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberBonusByDateDetailRebateService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    query += " FROM [000_Member_bonus_Rebate_detail]  (nolock) ";
