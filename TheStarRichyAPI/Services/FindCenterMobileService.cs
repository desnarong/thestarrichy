...
{
    public interface IFindCenterMobileService
    {
        Task<List<dynamic>> GetDisplayAsync(string centerCode);
    }
    public class FindCenterMobileService : IFindCenterMobileService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public FindCenterMobileService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync(string centerCode)
        {
            ...
            {
                return new List<dynamic> { new { centerCode = "" } };
            }
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT  CenterID, CenterName ";
                    query += " FROM [000_GetCenterNameinTeam]   ";
                    query += " where CenterID = @centerCode and @Membercode=DLcode  ";
