...
{
    public interface IMemberFavoriteAddressService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class MemberFavoriteAddressService : IMemberFavoriteAddressService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberFavoriteAddressService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    query += " ORDER BY Contact_Primary,Contact_TAMBON_ID,ContacNickname    ";
