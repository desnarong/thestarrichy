...
{
    public interface IReportMemberLeftTeamService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberLeftTeamService : IReportMemberLeftTeamService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberLeftTeamService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
