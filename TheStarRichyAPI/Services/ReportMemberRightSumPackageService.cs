...
{
    public interface IReportMemberRightSumPackageService
    {
        Task<List<dynamic>> GetDisplayAsync();
    }
    public class ReportMemberRightSumPackageService : IReportMemberRightSumPackageService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ReportMemberRightSumPackageService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetDisplayAsync()
        {
            ...
            try
            {
                using (var con = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT  Membercode,  PositionName  ,Totalmember" +
                        " FROM [000_Member_Right_Sum_position_package] where Membercode=@Membercode ORDER BY M24_X8 ";
