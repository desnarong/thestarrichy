...
{
    public interface IMemberTeamByRegionService
    {
        Task<List<dynamic>> GetMember2DisplayAsync();
    }
    public class MemberTeamByRegionService : IMemberTeamByRegionService
    {
        private readonly IConfiguration _configuration;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public MemberTeamByRegionService(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public async Task<List<dynamic>> GetMember2DisplayAsync()
        {
            ...
            try
            {
                ...
                {
                    await con.OpenAsync();
                    string query = "SELECT * FROM [000_Member_team_by_Region] WHERE Membercode = @Membercode order by Region_ID";
